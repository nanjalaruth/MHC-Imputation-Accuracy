...
if ($PREPARE) then
    ...
    java -Xmx2000m -jar $SCRIPTPATH/linkage2beagle.jar $OUTPUT.dat $OUTPUT.nopheno.ped > $OUTPUT.bgl 
...
if ($PHASE) then
    ...
    java -Xmx3000m -jar $SCRIPTPATH/beagle.jar unphased=$OUTPUT.bgl nsamples=4 niterations=10 missing=0 verbose=true maxwindow=1000 log=$OUTPUT.phasing > $OUTPUT.bgl.log
endif
