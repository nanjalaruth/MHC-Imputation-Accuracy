...
# nextflow -c /scratch3/users/nanje/MHC-Imputation-Accuracy/nextflow.config run /scratch3/users/nanje/MHC-Imputation-Accuracy/hlaped.nf -profile singularity -resume
