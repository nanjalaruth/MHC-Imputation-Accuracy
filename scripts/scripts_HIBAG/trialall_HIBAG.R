...
#STEP 1
##LOAD SNP GENOTYPES
bed.fn <- "./1kg_all_1kg_all_geno.bed"
fam.fn <- "./1kg_all_1kg_all_geno.fam"
bim.fn <- "./1kg_all_1kg_all_geno.bim"
...
#                    information = "Training set -- 1000 genomes",
#                    warning = NULL,
#                    rm.unused.snp=TRUE, anonymize=TRUE)

# save(mobj, file="1kg_all_1kg_all_HLA_A_Model.RData")
...
# save(mobj, file="1kg_all_1kg_all_HLA_B_Model.RData")
...
# save(mobj, file="1kg_all_1kg_all_HLA_C_Model.RData")
...
model.obj <- get(load("1kg_all_HLA_C_Model.RData"))
model <- hlaModelFromObj(model.obj)
summary(model)
