...
#STEP 1
##LOAD SNP GENOTYPES
bed.fn <- "/scratch3/users/nanje/MHC-Imputation-Accuracy/datasets/HAPMAP_CEU.bed"
fam.fn <- "/scratch3/users/nanje/MHC-Imputation-Accuracy/datasets/HAPMAP_CEU.fam"
bim.fn <- "/scratch3/users/nanje/MHC-Imputation-Accuracy/datasets/HAPMAP_CEU.bim"
geno <- hlaBED2Geno(bed.fn, fam.fn, bim.fn, assembly="hg19")

#STEP 2
##LOAD HLA TYPES
HLA_Type_Table <- read.table(file="/scratch3/users/nanje/MHC-Imputation-Accuracy/datasets/HAPMAP_CEU_HLA.ped")
head(HLA_Type_Table)
dim(HLA_Type_Table)
...
#mobj <- hlaPublish(model,
   ...
   #                information = "Training set -- 1000 genomes, african subpop",
  #                 warning = NULL,
 #                  rm.unused.snp=TRUE, anonymize=TRUE)

#save(mobj, file="1kg_all_africans_HLA_A_Model.RData")
...
# #STEP 2
# ##LOAD HLA TYPES
# HLA_Type_Table <- read.table(file="./gambian_hibag_HLAType.edited")
# head(HLA_Type_Table)
# dim(HLA_Type_Table)
...
#mobj <- hlaPublish(model,
 #                  platform = "Illumina 1M Duo",
  #                 information = "Training set -- 1000 genomes, africans",
   #                warning = NULL,
    #               rm.unused.snp=TRUE, anonymize=TRUE)

#save(mobj, file="1kg_all_africans_HLA_B_Model.RData")
...
#save(mobj, file="1kg_all_africans_HLA_C_Model.RData")
