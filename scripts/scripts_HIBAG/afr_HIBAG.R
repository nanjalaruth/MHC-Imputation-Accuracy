...
#STEP 1
##LOAD SNP GENOTYPES
bed.fn <- "./1kg_all_africans_geno.bed"
fam.fn <- "./1kg_all_africans_geno.fam"
bim.fn <- "./1kg_all_africans_geno.bim"
...
# save(mobj, file="africans_HLA_A_Model.RData")
...
model.obj <- get(load("africans_HLA_A_Model.RData"))
...
# save(mobj, file="africans_HLA_B_Model.RData")
...
model.obj <- get(load("africans_HLA_B_Model.RData"))
model <- hlaModelFromObj(model.obj)
summary(model)
...
# save(mobj, file="africans_HLA_C_Model.RData")
...
model.obj <- get(load("africans_HLA_C_Model.RData"))
model <- hlaModelFromObj(model.obj)
summary(model)
