...
#     echo "Please copy linkage2beagle.jar included in the beagle 3.0.4 zip file (beagle.3.0.4/utility/linkage2beagle.jar) into /usr/local/bin/"; exit 1
# else if (! -e /usr/local/bin/beagle2linkage.jar) then # We use beagle2linkage (Buhm, 8/13/12)
#     echo "Please copy beagle2linkage.jar (http://faculty.washington.edu/browning/beagle_utilities/utilities.html) into /usr/local/bin/"; exit 1
# else if (! -e \$MERGE) then
#     echo "Please copy merge_tables.pl (included with this package) into /usr/local/bin/"; exit 1
# else if (! -e \$PARSEDOSAGE) then
#     echo "Please copy ParseDosage.csh (included with this package) into /usr/local/bin/"; exit 1
# endif


set MERGE=/usr/local/bin/merge_tables.pl
set PARSEDOSAGE=/usr/local/bin/ParseDosage.csh
